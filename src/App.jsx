  ...
  return (
    <div style={{ maxWidth: 700, margin: "40px auto", padding: 24, border: "1px solid #e5e7eb", borderRadius: 12 }}>
      ...
      <div style={{ fontSize: 11, color: "#9ca3af", marginTop: 14 }}>
        ...
        <br />
        Toate cele 35 de luni de antrenament sunt încărcate. Unele luni mai vechi (9, 10, 12, 13, 17–19) pot avea câteva exerciții fără link video sau fără reps completate.
      </div>
    </div>
  );
}
